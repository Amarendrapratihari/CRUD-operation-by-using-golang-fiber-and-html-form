...
func TestInsertStudent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := InsertStudent(tt.args.db, tt.args.student_name, tt.args.father_name, tt.args.class, tt.args.age); got != tt.want {
				t.Errorf("InsertStudent() = %v, want %v", got, tt.want)
			}
		})
	}
}
